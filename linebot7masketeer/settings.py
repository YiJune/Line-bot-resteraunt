"""
Django settings for linebot7masketeer project.
...
try:
    ...
    PYMONGO_CLIENT=get_env_variable('PYMONGO_CLIENT')
except ImproperlyConfigured:
...
ROOT_URLCONF = 'linebot7masketeer.urls'
...
WSGI_APPLICATION = 'linebot7masketeer.wsgi.application'
